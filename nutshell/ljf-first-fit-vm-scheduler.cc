...
#include "ljf-first-fit-vm-scheduler.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE("LjfFirstFitVmScheduler");


NS_OBJECT_ENSURE_REGISTERED (LjfFirstFitVmScheduler);

TypeId LjfFirstFitVmScheduler::GetTypeId ()
{
	static TypeId tid = TypeId("ns3::LjfFirstFitVmScheduler")
		.SetParent<VmScheduler> ()
		.AddConstructor<LjfFirstFitVmScheduler> ();
	return tid;
}

LjfFirstFitVmScheduler::LjfFirstFitVmScheduler() {
	// TODO Auto-generated constructor stub

}

LjfFirstFitVmScheduler::LjfFirstFitVmScheduler(DatacenterConfig config)
{
	m_config = config;
}
...
void
LjfFirstFitVmScheduler::SortVmList()
{
	NS_LOG_INFO(this);
