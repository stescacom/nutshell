...
#ifndef SCRATCH_NUTSHELL_LJF_FIRST_FIT_VM_SCHEDULER_H
#define SCRATCH_NUTSHELL_LJF_FIRST_FIT_VM_SCHEDULER_H
...
class LjfFirstFitVmScheduler : public VmScheduler {
public:
	/**
	...
	*/
	 ...
	 */
	LjfFirstFitVmScheduler(DatacenterConfig config);
	virtual ~LjfFirstFitVmScheduler();
protected:
...
#endif /* SCRATCH_NUTSHELL_LJF_FIRST_FIT_VM_SCHEDULER_H */
